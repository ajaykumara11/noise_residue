...
with fits.open('/home/kumara/Downloads/hmi.M_45s.20221020_212015_TAI.2.magnetogram_normalisedByNoiseCLV.fits') as hdu:
    data=hdu[0].data
    header=hdu[0].header
array=data
mu=array.copy()
...
def movingWindowStdDev(numpy.ndarray[double, ndim=2] data, 
    ...
    print(f"done for the block_with_{startx},{endx},{starty},{endy}")
    return stdDevArray
